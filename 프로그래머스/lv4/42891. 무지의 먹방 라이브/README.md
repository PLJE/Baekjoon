...
![image](https://user-images.githubusercontent.com/77712822/227783511-1448c794-5466-485b-91b6-3ccbde5eca4e.png)
...
다른 경우는 예시로 row = 4 에서는, row 값 이상인 item column에만 채워지므로, 4 4 7 에만 k값들이 채워진다.   
